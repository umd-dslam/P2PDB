...
This is a blockchain stack and library modularized out of the [P2PDB](https://github.com/DSLAM-UMD/P2PDB) project, and bundled separately to follow the Unix philosophy that favors composability as opposed to monolithic design.
