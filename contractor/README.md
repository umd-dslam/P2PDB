...
This is a contractor reference implementation modularized out of the [P2PDB](https://github.com/DSLAM-UMD/P2PDB) project, and bundled separately to follow the Unix philosophy that favors composability as opposed to monolithic design.
